...
class Eagle25VLConfig(PretrainedConfig):
    ...
    def __init__(
        ...
        # Export-vendored default: eager (not flash_attention_2). ONNX/TRT
        # can't consume FA2 ops. Training code can explicitly pass
        # _attn_implementation='flash_attention_2' if running on FA2-capable
        # hardware.
